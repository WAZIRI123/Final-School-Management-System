<div>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemCreation">
        ...
        <div class="grid grid-cols-2 gap-8">
            <div class="mt-4">
                <x-tall-crud-label>Class Name</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-full" type="text" wire:model.defer="item.class_name" />
                @error('item.class_name') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
            <div class="mt-4">
                <x-tall-crud-label>Class Code</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-full" type="text" wire:model.defer="item.class_code" disabled />
                @error('item.class_code') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
        </div>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemEdit">
        ...
        <div class="grid grid-cols-2 gap-8">
            ...
            <div class="mt-4">
                <x-tall-crud-label>Class Code</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-full" type="text" wire:model.defer="item.class_code" />
                @error('item.class_code') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
        </div>
        <div class="grid grid-cols-2 gap-8">
