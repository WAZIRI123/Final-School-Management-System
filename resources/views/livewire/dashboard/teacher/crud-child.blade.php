<div>
    ...
    <x-tall-crud-confirmation-dialog wire:model="confirmingItemDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-tall-crud-button mode="delete" wire:loading.attr="disabled" wire:click="deleteItem({{ $teacher }})">
                Delete</x-tall-crud-button>
        </x-slot>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemEdit">
        ...
        <x-slot name="footer">
            ...
            <x-tall-crud-button mode="add" wire:loading.attr="disabled" wire:click="editItem({{ $teacher}})">Save
            </x-tall-crud-button>
        </x-slot>
    </x-tall-crud-dialog-modal>
</div>