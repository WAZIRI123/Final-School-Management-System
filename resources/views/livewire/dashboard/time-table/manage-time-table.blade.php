<div class="mt-8 min-h-screen">
    ...
    <div class="flex justify-between">
        <div class="text-2xl">Timetables</div>
        <button type="submit" wire:click="$emitTo('dashboard.time-table.create-time-table', 'showCreateForm');" class="text-blue-500">
    ...
    <div class="mt-6">
        ...
        <table class="w-full my-8 whitespace-nowrap" wire:loading.class.delay="opacity-50">
            <thead class="bg-secondary text-gray-100 font-bold">
                ...
                <td class="px-2 py-2 capitalize" >Semester Id</td>
            ...
            @foreach($results as $result)
                <tr class="hover:bg-blue-300 {{ ($loop->even ) ? "bg-blue-100" : ""}}">
                    ...
                    <td class="px-3 py-2 capitalize" >
                        <button type="submit" wire:click="$emitTo('dashboard.time-table.create-time-table', 'showEditForm', {{ $result->id}});" class="text-green-500">
                            <x-tall-crud-icon-edit />
                        </button>
                        <button type="submit" wire:click="$emitTo('dashboard.time-table.create-time-table', 'showDeleteForm', {{ $result->id}});" class="text-red-500">
    ...
    @livewire('dashboard.time-table.create-time-table')
