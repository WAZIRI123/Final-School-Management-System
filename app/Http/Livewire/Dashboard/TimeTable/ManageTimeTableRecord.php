...
class ManageTimeTableRecord extends Component
{
   ...
   public $semesters;
    ...
    public function render():View
    {
     $this->authorize('viewAny', [Timetable::class, 'timetable']);
        ...
        return view('livewire.dashboard.time-table.manage-time-table-record',['results'=>$results])->layoutData(['title' => 'timetables | School Management System']);
    }
