<div>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemCreation">
        ...
        <div class="grid grid-cols-2 gap-8">
            ...
            <div class="mt-4">
                <x-tall-crud-label>Subect Code</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-full" type="text" wire:model.defer="item.subject_code" disabled/>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemEdit">
        ...
        <div class="grid grid-cols-2 gap-8">
            ...
            <div class="mt-4">
                <x-tall-crud-label>Subect Code</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-full" type="text" wire:model.defer="item.subject_code" />
                @error('item.subject_code') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
        </div>
        <div class="grid grid-cols-2 gap-8">
