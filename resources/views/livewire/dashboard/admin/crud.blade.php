<div class="mt-8 min-h-screen">
    ...
    <div class="flex justify-between">
        <div class="text-2xl">admins</div>
        <button type="submit" wire:click="$emitTo('dashboard.admin.crud-child', 'showCreateForm');" class="text-blue-500">
            ...
            @foreach($results as $result)
                <tr class="hover:bg-blue-300 {{ ($loop->even ) ? "bg-blue-100" : ""}}">
                    ...
                    <td class="py-3 pl-2 capitalize" >
                        <button type="submit" wire:click="$emitTo('dashboard.admin.crud-child', 'showEditForm', {{ $result->id}});" class="text-green-500">
                            <x-tall-crud-icon-edit />
                        </button>
                        <button type="submit" wire:click="$emitTo('dashboard.admin.crud-child', 'showDeleteForm', {{ $result->id}});" class="text-red-500">
    ...
    @livewire('dashboard.admin.crud-child')
</div>