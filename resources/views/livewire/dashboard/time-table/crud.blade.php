<div class="mt-8 min-h-screen">
    ...
    <div class="flex justify-between">
        ...
        <button type="submit" wire:click="$emitTo('dashboard.time-table.crud-child', 'showCreateForm');" class="text-blue-500">
            ...
            @foreach($results as $result)
                <tr class="hover:bg-blue-300 {{ ($loop->even ) ? "bg-blue-100" : ""}}">
                    ...
                    <td class="px-3 py-2 capitalize" >
                        ...
                        <button type="submit" wire:click="$emitTo('dashboard.time-table.crud-child', 'showDeleteForm', {{ $result->id}});" class="text-red-500">
    ...
    @livewire('dashboard.time-table.crud-child')
