...
class TimetablePolicy
{
    ...
    {
        if ($user->can('read timetable') && $user->school_id == $timetable->MyClass->school->id) {
            return true;
        }
    }
    ...
    {
        if ($user->can('update timetable') && $user->school_id == $timetable->MyClass->school->id) {
            return true;
        }
    }
    ...
    {
        if ($user->can('delete timetable') && $user->school_id == $timetable->MyClass->school->id) {
            return true;
        }
    }
